(() => {
    ...
    const EN = [
        ...
        ['Chi Phí', 'Cost'],
        ['Thời Lượng', 'Duration'],
        ['Thời Lượng Cửa Sổ', 'Window Duration'],
        ['Bắt Đầu', 'Started'],
        ['Bắt đầu', 'Started'],
        ['Thao Tác', 'Actions'],
        ...
        ['Nguồn', 'Source'],
        ['Gemini 5 Giờ:', 'Gemini 5 Hours:'],
        ['Gemini Tuần (7D):', 'Gemini Weekly (7D):'],
        ['Khung 5 Giờ (5-Hour)', '5-Hour Window'],
        ['Khung Tuần (7-Day Weekly)', 'Weekly Window (7 days)'],
        ['● Đã hồi phục 100%', '● Recovered to 100%'],
        ['● Đầy 100% (Tối ưu)', '● Full (100%)'],
        ['🟢 Đã đầy 100% (Tối ưu)', '🟢 Fully recovered (100%)'],
        ['🟢 Đã sẵn sàng 100%', '🟢 Ready (100%)'],
        ['Kích thước bảng', 'Table size'],
        ['Điều chỉnh riêng cho bảng này', 'Adjust this table'],
        ['Đặt lại kích thước', 'Reset size'],
        ['Đặt lại độ rộng cột', 'Reset column widths'],
        ...
        ['⚡ ARTIFICIAL ANALYSIS INTELLIGENCE INDEX v4.3.2 • CẬP NHẬT 21/09/2026', '⚡ ARTIFICIAL ANALYSIS INTELLIGENCE INDEX v4.3.2 • UPDATED 21/09/2026'],
        ...
        ['Bảng vẫn hiển thị model có thể chọn trong Codex hoặc đã dùng cục bộ khi AA chưa công bố điểm, đồng thời ghép', 'Models selectable in Codex or observed locally remain visible when AA has not published a score, together with'],
        ['; nhãn “ước tính” được giữ nguyên khi AA chưa hoàn tất đo độc lập. Bảng vẫn hiển thị model có thể chọn trong Codex hoặc đã dùng cục bộ khi AA chưa công bố điểm, đồng thời ghép', '; the “estimated” label is preserved when AA has not completed an independent measurement. Models selectable in Codex or observed locally remain visible when AA has not published a score, together with'],
        ['token, chi phí all-time và quota/task từ log cục bộ', 'local-log token totals, all-time cost, and quota/task measurements'],
        ['So Sánh Intelligence Index v4.3.2 Và Tốc Độ Output', 'Intelligence Index v4.3.2 vs Output Speed'],
        ['Tốc Độ Sinh Token (Output Tokens/giây)', 'Token Generation Speed (Output Tokens/sec)'],
        ['Bảng Quyết Định Model', 'Model Decision Table'],
        ['Mặc định hiện đầy đủ các model và mức reasoning đang có trong bộ chọn Codex. Dòng chưa được Artificial Analysis chấm vẫn xuất hiện nhưng không có hạng.', 'By default, all models and reasoning levels in the Codex picker are shown. Rows without an Artificial Analysis result remain visible but unranked.'],
        ['Phạm vi: Có thể chọn trong Codex', 'Scope: Selectable in Codex'],
        ...
        ['Phạm vi: Tất cả model', 'Scope: All models'],
        ['Phạm vi model', 'Model scope'],
        ['Họ model: Tất cả', 'Model family: All'],
        ['Họ model', 'Model family'],
        ['Xếp theo: Khuyến nghị', 'Sort by: Recommendation'],
        ['Xếp theo: Cột đã chọn', 'Sort by: Selected column'],
        ['Sắp theo AA cost/task; IQ/$ là chỉ số bổ sung', 'Sort by AA cost per task; IQ per dollar is supplementary.'],
        ['Sắp theo giá API input mỗi 1M; model chỉ có credit sẽ ở cuối', 'Sort by API input price per 1M; credit-only models come last.'],
        ['Sắp theo % quota/task khi đủ mẫu; số đo %/1M là chỉ số khác đơn vị và ở cuối', 'Sort by quota percent per task where measured; percent per 1M has a different unit and comes last.'],
        ['Sắp theo tổng token cục bộ; chi phí là chỉ số bổ sung', 'Sort by local total tokens; cost is supplementary.'],
        ['Sắp theo độ phủ token; mức tin cậy là thông tin bổ sung', 'Sort by token coverage; confidence is supplementary.'],
        ['Sắp theo tỷ lệ thành công; số lượt thử là bằng chứng bổ sung', 'Sort by success rate; attempt count is supplementary evidence.'],
        ...
        ['Cột chồng thể hiện chi phí quy đổi ước tính: Standard theo giá API, Fast theo hệ số credit ChatGPT. Biểu đồ dùng cùng khoảng thời gian và đơn vị Ngày / Tháng / Năm với biểu đồ tokens phía trên.', 'Stacked bars show estimated cost equivalents: Standard uses API prices, while Fast uses the ChatGPT credit multiplier. The chart shares the date range and Day / Month / Year grouping of the token chart above.'],
        ['Đơn vị', 'Unit'],
        ...
        ['1 credit = $0.01 chi phí quy đổi ước tính', '1 credit = $0.01 estimated cost equivalent'],
        ...
        ['Ghép mọi lượt sửa, giảng lại và tiếp tục cho đến khi một mục tiêu được chấp nhận. Ma trận gom toàn bộ các lượt liên quan thành một nhiệm vụ hoàn chỉnh rồi quy mức tiêu hao hạn mức Codex 5h theo model và loại việc; token được giữ làm bằng chứng phụ, mẫu chưa xác nhận vẫn được dùng với confidence thấp hơn.', 'Group every correction, re-explanation, and continuation until one objective is accepted. The matrix groups all related turns into a complete mission, then attributes effective Codex 5h quota consumption by model and task type. Tokens remain supporting evidence, while unconfirmed samples are retained at lower confidence.'],
        ...
        ['Usage Tracker — Theo dõi Codex và Gemini', 'Usage Tracker — Codex and Gemini Analytics'],
        ['Theo dõi token, hạn mức, chi phí và nhiệm vụ của Codex & Gemini', 'Track tokens, quota, cost, and tasks across Codex & Gemini'],
        ...
        ['Trần Hạn Mức Codex Tuần Tương Đương Theo USD', 'Codex Weekly API-Equivalent Capacity in USD'],
        ['Mỗi điểm là một lần suy luận từ chi phí quy đổi ước tính chia cho % hạn mức tuần đã tiêu hao. Standard theo giá API, Fast theo hệ số credit ChatGPT. Đường gần đây dùng cửa sổ thời gian để nhận ra thay đổi mới; đường hội tụ dùng toàn bộ điểm đo được giữ lại.', 'Each point infers full-week capacity from estimated cost equivalent divided by weekly quota percentage consumed. Standard uses API prices; Fast uses the ChatGPT credit multiplier. The recent line detects changes with a time window; the convergence line uses all retained measurements.'],
        ['Cửa sổ gần đây', 'Recent window'],
        ['Tài khoản Codex', 'Codex account'],
        ['Tài khoản Codex để đo trần tuần', 'Codex account for weekly capacity estimates'],
        ['Cửa sổ thời gian ước tính gần đây', 'Recent estimation time window'],
        ['Khoảng thời gian trần tuần tương đương', 'Date range for weekly equivalent capacity'],
        ['Khoảng', 'Range'],
        ['7 ngày', '7 days'],
        ['14 ngày', '14 days'],
        ['30 ngày', '30 days'],
        ...
        ['180 ngày', '180 days'],
        ['365 ngày', '365 days'],
        ['Phép đo riêng lẻ', 'Individual measurements'],
        ['Trung vị gần đây', 'Recent median'],
        ['Trung vị hội tụ', 'Convergence median'],
        ['USD là chi phí quy đổi ước tính, không phải hạn mức chính thức hay credit của tài khoản. Fast dùng hệ số credit ChatGPT theo tài liệu OpenAI. Phép đo có thể lệch khi nhiều phiên hoạt động đồng thời hoặc cơ cấu model thay đổi.', 'USD is an estimated cost equivalent, not an official allowance or account credit. Fast uses the documented ChatGPT credit multiplier. Concurrent sessions or a changing model mix may distort measurements.'],
        ...
        ['Ma trận gom toàn bộ các lượt liên quan thành một nhiệm vụ hoàn chỉnh rồi quy mức tiêu hao hạn mức Codex 5h theo model và loại việc; token được giữ làm bằng chứng phụ, mẫu chưa xác nhận vẫn được dùng với confidence thấp hơn.', 'The matrix groups all related turns into a complete mission, then attributes effective Codex 5h quota consumption by model and task type. Tokens remain supporting evidence, while unconfirmed samples are retained at lower confidence.'],
        ['Ma Trận Hao Phí Hạn Mức 5h Đến Khi Đạt Yêu Cầu', '5h Quota Consumption Until Acceptance Matrix'],
        ['Sol High là 1.00× trong cùng loại công việc. Hệ số dựa trên % hạn mức 5h hiệu dụng; token chỉ dùng để giải thích lượng công việc.', 'Sol High is 1.00× within each task type. Ratios use effective 5h quota consumption; tokens only explain the amount of work.'],
        ['Hệ số <1× tiêu hao ít hạn mức 5h hơn Sol High; >1× tiêu hao nhiều hơn.', 'A ratio below 1× consumes less 5h quota than Sol High; above 1× consumes more.'],
        ...
        ['Kích thước bảng', 'Table size'],
        ['Điều chỉnh riêng cho bảng này', 'Adjust this table'],
        ['API Trực Tiếp (Live Server)', 'Direct API (Live Server)'],
        ['GBPUSD / giao dịch', 'GBPUSD / trading'],
        ['SU-30 / tài liệu kỹ thuật', 'SU-30 / technical documents'],
        ['Hồ sơ nhân sự / tài liệu', 'Personnel records / documents'],
        ['Runtime / lỗi phần mềm Codex', 'Codex runtime / software issues'],
        ['Máy tính / điện thoại / mạng', 'Computer / phone / network'],
        ['Câu hỏi sản phẩm / model', 'Product / model questions'],
        ['Usage Tracker / model / hạn mức', 'Usage Tracker / model / quota'],
        ['Tài liệu / bảng biểu khác', 'Other documents / spreadsheets'],
        ['Chẩn đoán / phần mềm khác', 'Other diagnostics / software'],
        ['Nghiên cứu khác', 'Other research'],
        ['Làm web khác', 'Other web work'],
        ['Khác / chưa đủ ngữ cảnh', 'Other / insufficient context'],
        ['Lệnh tiếp tục thiếu tên việc', 'Continuation without a task name'],
        ['Câu hỏi / tư vấn', 'Question / advice'],
        ['Nhiệm vụ hành động / điều tra', 'Action / investigation task'],
        ['Không cần review từng mẫu. Hệ thống tách review cứng khỏi các nhóm audit đáng nghi để bạn quyết định rule theo từng mẫu tương đồng.', 'You do not need to review every sample. The tracker separates required reviews from suspicious audit groups so you can decide rules from similar cases.'],
        ['Tìm nội dung nhiệm vụ hoặc model…', 'Search mission content or model…'],
        ['Tất cả nhóm chưa xác nhận', 'All unconfirmed groups'],
        ['Tất cả nhóm audit', 'All audit groups'],
        ['Tất cả mission', 'All missions'],
        ['Chỉ audit đáng nghi', 'Suspicious audits only'],
        ['Chỉ review cứng', 'Required reviews only'],
        ['Không phải nhiệm vụ', 'Not a mission'],
        ['Tuyến model / nối lượt sửa', 'Model route / repair link'],
        ['Hạn mức 5h / token', '5h quota / tokens'],
        ['Nối lượt sửa với nhiệm vụ', 'Link repair turn to mission'],
        ['Nhiệm vụ đã ghép', 'Grouped missions'],
        ['Từ các lượt Codex trực tiếp', 'From direct Codex turns'],
        ['Xác nhận hoặc suy ra có độ tin cậy', 'Confirmed explicitly or inferred with confidence'],
        ['Cần kiểm tra trước khi dùng', 'Review before using'],
        ['Nhóm chưa xác nhận', 'Unconfirmed groups'],
        ['Gom theo chủ đề và dạng yêu cầu để duyệt hàng loạt', 'Grouped by topic and request form for batch review'],
        ['Loại khỏi ma trận', 'Excluded from matrix'],
        ['Lời chào, thử kết nối hoặc mục không phải nhiệm vụ', 'Greetings, connection tests, or non-mission items'],
        ['Đổi model / subagent', 'Model switch / subagent'],
        ['Tuyến không quy được bị loại; lượt sửa lỗi được quy riêng', 'Unattributable routes are excluded; repair turns are attributed separately'],
        ['Đã được anh kiểm tra', 'Manually reviewed'],
        ['Loại việc hoặc kết quả đã sửa tay', 'Task type or outcome was manually corrected'],
        ['Case khó cần xem', 'Hard cases to review'],
        ['Chỉ lượt mơ hồ, nhãn khác hoặc độ tin cậy thấp', 'Only ambiguous turns, other labels, or low-confidence cases'],
        ['Audit đáng nghi', 'Suspicious audits'],
        ['Phạt sửa lỗi', 'Repair penalty'],
        ['Token sửa bằng model khác cộng thêm cho model gây lỗi', 'Tokens spent by another model on the repair are also charged to the model that caused the failure'],
        ['Đã đạt · anh xác nhận', 'Accepted · user confirmed'],
        ['Đã đạt · phát hiện câu xác nhận', 'Accepted · confirmation detected'],
        ['Đã đạt · suy ra từ nhiệm vụ kế', 'Accepted · inferred from the next mission'],
        ['Đã đạt · suy ra do không có lượt sửa', 'Accepted · inferred because no repair followed'],
        ['Chưa xác nhận · anh đánh dấu', 'Unconfirmed · user marked'],
        ['Đã bỏ dở · anh đánh dấu', 'Abandoned · user marked'],
        ['Model không đạt · model khác sửa tiếp', 'Model failed · another model repaired it'],
        ['Model không đạt · anh tự sửa bằng tay', 'Model failed · user repaired manually'],
        ['Model không đạt · anh xác nhận tự sửa', 'Model failed · manual repair confirmed'],
        ['Không phải nhiệm vụ · loại khỏi ma trận', 'Not a mission · excluded from matrix'],
        ['Đã đạt yêu cầu · xác nhận trực tiếp', 'Accepted · directly confirmed'],
        ['Model không đạt · tôi tự sửa bằng tay', 'Model failed · I repaired it manually'],
        ['Không phải lượt sửa', 'Not a repair turn'],
        ['Liên kết đã lưu', 'Saved link'],
        ['Mốc Sol High', 'Sol High baseline'],
        ['Chưa có nhiệm vụ một model đã đạt yêu cầu trong khoảng này.', 'No accepted single-model missions are available in this range.'],
        ['Chưa đủ dữ liệu đã đạt yêu cầu để lập ma trận.', 'There is not enough accepted-mission data to build the matrix.'],
        ['Chưa đo được hạn mức 5h', 'No 5h quota measurement'],
        ['Chưa đủ mốc hạn mức Sol High', 'Insufficient Sol High quota baseline'],
        ['phí chưa rõ', 'cost unavailable'],
        ['bắc cầu', 'bridged'],
        ['toàn bộ dữ liệu', 'all data'],
        ['Không có nhiệm vụ phù hợp bộ lọc.', 'No missions match the current filters.'],
        ['chưa xác định loại', 'task type unknown'],
        ['tin cậy phân loại thấp', 'low classification confidence'],
        ['thiếu chi tiết theo lượt', 'turn details unavailable'],
        ['có lượt khó phân loại', 'contains a hard-to-classify turn'],
        ['liên kết lượt sửa chưa chắc', 'repair link is uncertain'],
        ['đang thuộc review cứng', 'currently requires review'],
        ['tin cậy cao nhưng có category cạnh tranh', 'high confidence with competing categories'],
        ['follow-up kế thừa trong mission trộn', 'inherited follow-up in a mixed mission'],
        ['tín hiệu category hòa điểm', 'task-type signals are tied'],
        ['mission đa chức năng do máy tự gán', 'automatically assigned multi-function mission'],
        ['vừa đổi model vừa đổi chức năng', 'both model and function changed'],
        ['nối lượt sửa tự động chưa đủ chắc', 'automatic repair link is uncertain'],
        ['có khoảng nghỉ dài giữa các lượt', 'long gap between turns'],
        ['model trước', 'previous model'],
        ['đã hiệu chỉnh', 'reviewed'],
        ['Ghép mục trước', 'Merge with previous'],
        ['Tách lượt cuối', 'Split final turn'],
        ['Trả tự động', 'Reset to automatic'],
        ['Review cứng hiện tại', 'Currently requires review'],
        ['Tin cậy cao + category cạnh tranh', 'High confidence + competing categories'],
        ['Follow-up kế thừa trong mission trộn', 'Inherited follow-up in mixed mission'],
        ['Tín hiệu category hòa điểm', 'Tied task-type signals'],
        ['Mission đa chức năng tự động', 'Automatic multi-function mission'],
        ['Đổi model + đổi chức năng', 'Model switch + function change'],
        ['Nối lượt sửa tự động chưa chắc', 'Uncertain automatic repair link'],
        ['Khoảng nghỉ dài giữa các lượt', 'Long gap between turns'],
        ['Đã lưu hiệu chỉnh nhiệm vụ.', 'Mission review saved.'],
        ...
        ['Thời Gian Hoàn Thành Trung Bình Theo Model', 'Average Task Completion Time by Model'],
        ['Mỗi đường là thời gian xử lý trung bình của một model + effort cho nhiệm vụ đã đạt yêu cầu. Chỉ dùng nhiệm vụ do một model làm từ đầu đến cuối; khoảng chờ giữa các lượt được loại trừ.', 'Each line shows mean active completion time for one model + effort on accepted tasks. Only tasks handled by one model from start to finish are included; waiting between turns is excluded.'],
        ['Phạm vi biểu đồ thời gian nhiệm vụ', 'Task-duration chart range'],
        ['Cửa sổ trung bình trượt thời gian nhiệm vụ', 'Rolling mean window for task duration'],
        ['Chọn model trong biểu đồ thời gian hoàn thành', 'Select models in the task-duration chart'],
        ['Thời gian hoàn thành trung bình theo model của nhiệm vụ Codex đã đạt yêu cầu', 'Mean task-completion time by model for accepted Codex tasks'],
        ['Trung Bình Cửa Sổ', 'Window Mean'],
        ['Trung Vị Cửa Sổ', 'Window Median'],
        ['Mẫu Cửa Sổ', 'Window Samples'],
        ['Mẫu Phạm Vi', 'Range Samples'],
        ['Đã Xác Nhận', 'Reviewed'],
        ['Đang đọc dữ liệu thời gian theo model…', 'Reading task duration by model…'],
        ...
        ['output tokens/giây', 'output tokens/sec'],
        ...
        ['AA công bố', 'AA published'],
        ['AA chưa công bố', 'AA not published'],
        ['AA chưa chấm', 'AA not scored'],
        ['AA chưa có dữ liệu cho model này', 'AA has no data for this model'],
        ['có thể chọn', 'selectable'],
        ['đã thấy trong log', 'observed in logs'],
        ['Codex credit Standard', 'Codex credits Standard'],
        ['Credit Codex chính thức · tốc độ Standard; khác credit chuẩn hóa trong biểu đồ chi phí', 'Official Codex credits at Standard speed; different from normalized credits in the cost chart'],
        ['Hiện các model trong bộ chọn Codex và model mới đã thấy trong log. Model chưa được Artificial Analysis chấm vẫn xuất hiện nhưng không có hạng. Giá API và credit Codex dùng hai bảng giá riêng.', 'Shows Codex picker models and newly observed models from logs. Models without Artificial Analysis scores remain visible but unranked. API dollars and Codex credits use separate rate cards.'],
        ['Phạm vi: Có thể chọn / đã quan sát', 'Scope: Selectable / observed'],
        ['API $ / Codex credit mỗi 1M In · Cache · Out', 'API $ / Codex credits per 1M In · Cache · Out'],
        ['Có thể chọn trong Codex', 'Selectable in Codex'],
        ['Nguồn nhà cung cấp', 'Provider source'],
        ['ước tính', 'estimated'],
        ['đời trước', 'previous generation'],
        ['Dữ liệu lịch sử', 'Historical data'],
        ['Lựa chọn', 'Choice'],
        ['Chất lượng cao nhất', 'Highest quality'],
        ['Dùng cho nhiệm vụ khó nhất khi chất lượng quan trọng hơn chi phí và độ trễ.', 'Use for the hardest tasks when quality matters more than cost and latency.'],
        ['Cân bằng chất lượng và số task', 'Balance quality and task capacity'],
        ['Mặc định cho công việc hằng ngày; chất lượng tốt và quota/task cục bộ hiện thấp hơn XHigh.', 'Default for daily work; strong quality and currently lower local quota per task than XHigh.'],
        ['Việc khó cần reasoning cao', 'Hard work needing deeper reasoning'],
        ['Điểm AA cao hơn High; dùng khi phần reasoning thêm có thể tránh làm lại, vì quota/task cục bộ hiện cao hơn High.', 'AA scores it above High; use it when deeper reasoning may prevent rework, because its current local quota per task is higher than High.'],
        ['Cân bằng theo giá API', 'Balance by API price'],
        ['Phù hợp khi muốn giảm giá API so với Sol nhưng vẫn giữ reasoning mạnh.', 'Suitable when you want lower API pricing than Sol while retaining strong reasoning.'],
        ['Giá trị và khối lượng lớn', 'Value and high volume'],
        ['Chi phí AA/task thấp nhất trong nhóm khuyến nghị; hợp với việc dễ kiểm chứng và chạy số lượng lớn.', 'Lowest AA cost per task in the recommended set; suitable for verifiable, high-volume work.'],
        ['Tốc độ và đa phương thức', 'Speed and multimodality'],
        ['Nhanh nhất trong nhóm khuyến nghị, phù hợp tác vụ đa phương thức và vòng lặp ngắn.', 'Fastest in the recommended set; suitable for multimodal tasks and short iteration loops.'],
        ['Frontier model cho công việc chuyên môn phức tạp, reasoning và coding.', 'Frontier model for complex professional work, reasoning, and coding.'],
        ['Cân bằng intelligence và chi phí cho workload coding/reasoning thường xuyên.', 'Balances intelligence and cost for regular coding and reasoning workloads.'],
        ['Workload khối lượng lớn, nhạy chi phí và cần context lớn.', 'High-volume, cost-sensitive workloads that need a large context window.'],
        ['Chưa đủ mẫu', 'Insufficient samples'],
        ['chưa định giá đủ', 'incomplete pricing'],
        ['Chưa có usage trong bộ lọc', 'No usage in the current filter'],
        ['Bằng Chứng Model Sửa Thành Công Cho Model Khác', 'Evidence of Models Successfully Repairing Other Models'],
        ['Chỉ tính chuỗi sửa khác model đã đạt yêu cầu. Điểm Intelligence của Artificial Analysis là tín hiệu năng lực bổ trợ; kết quả sửa thực tế và hạn mức tiêu hao vẫn là bằng chứng chính.', 'Only accepted cross-model repair chains are counted. Artificial Analysis Intelligence is a supporting capability signal; observed repair outcomes and quota consumption remain the primary evidence.'],
        ['Model cần được sửa', 'Model that needed repair'],
        ['Model sửa thành công', 'Successful repair model'],
        ['Loại nhiệm vụ', 'Task type'],
        ['Thành công / lượt thử', 'Successes / attempts'],
        ['Hạn mức sửa trung vị', 'Median repair quota'],
        ['Bằng chứng năng lực', 'Capability evidence'],
        ['Chưa có chuỗi sửa khác model đã đạt yêu cầu.', 'No accepted cross-model repair chain is available yet.'],
        ['Học setup giao dịch', 'Trading setup study'],
        ['Làm web', 'Web development'],
        ['Mô phỏng 3D', '3D simulation'],
        ['Sửa lỗi phần mềm', 'Software debugging'],
        ...
        ['Chưa đo được', 'Not measured'],
        ['AA chưa đủ dữ liệu để so sánh năng lực', 'AA lacks enough data for a capability comparison'],
        ['AA Intelligence ngang nhau', 'Equal AA Intelligence'],
        ['AA chỉ là tín hiệu bổ trợ.', 'AA is only a supporting signal.'],
        ['Cục bộ:', 'Local:'],
        ...
        ['• Theo dõi Codex và Gemini/Antigravity trên máy của bạn', '• Local Codex and Gemini/Antigravity analytics'],
        ['Hệ số quy đổi ước lượng: ~3 ký tự/token cho nội dung song ngữ Việt/Anh + mã nguồn', 'Estimated conversion: ~3 characters/token for mixed Vietnamese/English text plus source code'],
    ...
    const DYNAMIC_RULES = [
        ...
        [/^(\d+)\/(\d+) biến thể$/, '$1/$2 variants'],
        [/^(\d+) cặp đã quan sát$/, '$1 observed pairs'],
        [/^Lựa chọn (\d+)$/, 'Choice $1'],
        [/^AA Intelligence cao hơn ([\d.,]+) điểm$/, 'AA Intelligence is $1 points higher'],
        [/^AA Intelligence thấp hơn ([\d.,]+) điểm$/, 'AA Intelligence is $1 points lower'],
        [/^Đã sửa thành công · tin cậy (low|medium|high)$/, 'Observed successful repair · $1 confidence'],
        [/^(\d+) khoảng đo • (low|medium|high)$/, '$1 intervals • $2'],
        [/^(\d+) nhiệm vụ$/, '$1 missions'],
        [/^(\d+) \/ (\d+) nhiệm vụ$/, '$1 / $2 missions'],
        [/^(\d+) nhóm tín hiệu lặp lại, chưa phải lỗi chắc chắn$/, '$1 recurring signal groups; not confirmed errors'],
        [/^n=(\d+) · ([\d.,]+[KMB]?) token tham khảo$/, 'n=$1 · $2 reference tokens'],
        [/^Chưa đủ mẫu hạn mức \(n=(\d+)\)$/, 'Insufficient quota samples (n=$1)'],
        [/^Model này: ([\d.,]+)% 5h · n=(\d+)$/, 'This model: $1% 5h · n=$2'],
        [/^Tạm tính từ median trực tiếp ([\d.,—]+)% hạn mức 5h$/, 'Provisional value from direct median: $1% of 5h quota'],
        [/^Ước lượng ([\d.,—]+)% hạn mức 5h$/, 'Estimated $1% of 5h quota'],
        [/^([\d.,—]+)% hạn mức 5h$/, '$1% of 5h quota'],
        [/^([\d.,]+[KMB]?) token tham khảo · (\$[\d.,]+)$/, '$1 reference tokens · $2'],
        [/^([\d.,]+[KMB]?) token tham khảo · phí chưa rõ$/, '$1 reference tokens · cost unavailable'],
        [/^([\d.,]+[KMB]?) token tham khảo$/, '$1 reference tokens'],
        [/^Dữ liệu trực tiếp: n=(\d+) · median ([\d.,]+[KMB]?) token$/, 'Direct data: n=$1 · median $2 tokens'],
        [/^Dữ liệu trực tiếp: n=(\d+)$/, 'Direct data: n=$1'],
        [/^n=(\d+) · sửa ([\d.,]+) lượt · đạt lần đầu ([\d.,]+)%$/, 'n=$1 · $2 correction turns · $3% first-pass acceptance'],
        [/^Gốc ([\d.,]+[KMB]?) \+ phạt sửa lỗi ([\d.,]+[KMB]?) token$/, 'Base $1 + $2 repair-penalty tokens'],
        [/^Hạn mức gốc ([\d.,]+)% \+ phạt ([\d.,]+)%$/, 'Base quota $1% + $2% penalty'],
        [/^([\d.,]+×) · ước lượng$/, '$1 · estimated'],
        [/^([\d.,]+×) · mẫu ít$/, '$1 · sparse sample'],
        [/^Công dạy ~([\d.,]+[KMB]?) token · tin cậy (.+)$/, 'Extra guidance ~$1 tokens · confidence $2'],
        [/^tin cậy (.+)$/, 'confidence $1'],
        [/^Tự động \((.+)\)$/, (_match, inner) => `Automatic (${inner.split(' + ').map(part => EN_EXACT.get(part) || part).join(' + ')})`],
        [/^Tự động: (.+) · tin cậy (high|medium|low)$/, 'Automatic: $1 · confidence $2'],
        [/^Tự động: (.+)$/, 'Automatic: $1'],
        [/^Tự động · tin cậy (.+)$/, 'Automatic · confidence $1'],
        [/^Liên kết đã lưu · (.+)$/, 'Saved link · $1'],
        [/^Cần xem lại: (.+)$/, 'Review required: $1'],
        [/^Đáng audit \((.+)\): (.+)$/, 'Audit candidate ($1): $2'],
        [/^Sửa cho (.+) · ([\d.,]+[KMB]?) token · phạt ([\d.,]+[KMB]?)$/, 'Repairs $1 · $2 tokens · penalty $3'],
        [/^Sửa cho (.+) · ([\d.,]+[KMB]?) token$/, 'Repairs $1 · $2 tokens'],
        [/^Phạt sửa lỗi \+([\d.,]+[KMB]?) token · \+([\d.,]+)% hạn mức$/, 'Repair penalty +$1 tokens · +$2% quota'],
        [/^Phạt sửa lỗi \+([\d.,]+[KMB]?) token$/, 'Repair penalty +$1 tokens'],
        [/^Chuỗi sửa: (.+)$/, 'Repair chain: $1'],
        [/^([\d.,]+[KMB]?) token · phí chưa rõ$/, '$1 tokens · cost unavailable'],
        [/^chưa đo được hạn mức · (.+)$/, 'quota not measured · $1'],
        [/^hạn mức model (.+?) · support (\d+) · mốc hạn mức Sol (.+?) · support (\d+)$/, 'model quota $1 · support $2 · Sol quota baseline $3 · support $4'],
        [/^hạn mức model (.+?) · support (\d+)$/, 'model quota $1 · support $2'],
        [/^mốc hạn mức Sol (.+?) · support (\d+)$/, 'Sol quota baseline $1 · support $2'],
        [/^(.+) · tự động$/, '$1 · automatic'],
        [/^(.+) · đã hiệu chỉnh$/, '$1 · reviewed'],
        [/^(.+?) · (Lệnh tiếp tục thiếu tên việc|Câu hỏi \/ tư vấn|Nhiệm vụ hành động \/ điều tra) \((\d+)\)$/, (_match, topic, form, count) => `${EN_EXACT.get(topic) || topic} · ${EN_EXACT.get(form) || form} (${count})`],
        [/^Lượt (\d+)$/, 'Turn $1'],
        [/^Xem (\d+) lượt làm việc$/, 'View $1 work turns'],
        [/^Có (\d+) lượt subagent · ([\d.,]+[KMB]?) token$/, '$1 subagent turns · $2 tokens'],
        [/^Chỉ hiện 300\/([\d.,]+) kết quả phù hợp\.$/, 'Showing 300/$1 matching results.'],
        [/^toàn bộ dữ liệu · ([\d.,]+) nhiệm vụ hợp lệ; hệ số chính là % hạn mức Codex 5h hiệu dụng đến khi đạt yêu cầu, còn token chỉ là dữ liệu giải thích\. Mỗi n là một nhiệm vụ hoàn chỉnh sau khi cộng các lượt\/model\/loại việc liên quan\. Nhiệm vụ chưa xác nhận vẫn được dùng với độ tin cậy thấp hơn; ([\d.,]+) mẫu có quy hao phí sửa lỗi lũy kế\. Cần ít nhất (\d+) nhiệm vụ để có số trực tiếp\. Mốc (.+) cùng loại việc được ưu tiên; dữ liệu hạn mức đo trực tiếp được dùng trước, sau đó mới đến tốc độ tiêu hao thực nghiệm theo model và ước lượng bắc cầu\.$/, 'all data · $1 eligible missions; the primary ratio is effective Codex 5h quota consumption until acceptance, while tokens remain explanatory evidence. Each n is one complete mission after combining related turns, models, and task types. Unconfirmed missions remain included at lower confidence; $2 samples include cumulative repair-cost attribution. At least $3 missions are required for a direct value. The $4 baseline within the same task type is preferred; direct quota measurements are used first, followed by empirical model burn rates and bridged estimates.'],
        [/^(\d+) ngày · ([\d.,]+) nhiệm vụ hợp lệ; hệ số chính là % hạn mức Codex 5h hiệu dụng đến khi đạt yêu cầu, còn token chỉ là dữ liệu giải thích\. Mỗi n là một nhiệm vụ hoàn chỉnh sau khi cộng các lượt\/model\/loại việc liên quan\. Nhiệm vụ chưa xác nhận vẫn được dùng với độ tin cậy thấp hơn; ([\d.,]+) mẫu có quy hao phí sửa lỗi lũy kế\. Cần ít nhất (\d+) nhiệm vụ để có số trực tiếp\. Mốc (.+) cùng loại việc được ưu tiên; dữ liệu hạn mức đo trực tiếp được dùng trước, sau đó mới đến tốc độ tiêu hao thực nghiệm theo model và ước lượng bắc cầu\.$/, '$1 days · $2 eligible missions; the primary ratio is effective Codex 5h quota consumption until acceptance, while tokens remain explanatory evidence. Each n is one complete mission after combining related turns, models, and task types. Unconfirmed missions remain included at lower confidence; $3 samples include cumulative repair-cost attribution. At least $4 missions are required for a direct value. The $5 baseline within the same task type is preferred; direct quota measurements are used first, followed by empirical model burn rates and bridged estimates.'],
        [/^Đã lập chỉ mục ([\d.,]+[KMB]?) lượt; gắn ([\d.,]+[KMB]?) lượt subagent vào nhiệm vụ cha\. “Review cứng” là case yếu hoặc chưa rõ; “audit đáng nghi” là case máy đang khá tự tin nhưng có tổ hợp tín hiệu nên kiểm tra\. Chọn một nhóm audit để duyệt các mẫu tương đồng và chốt rule\.$/, 'Indexed $1 turns; attached $2 subagent turns to their parent missions. “Required review” covers weak or unclear cases; “suspicious audit” covers cases where the classifier is fairly confident but the signal combination merits review. Select an audit group to review similar samples and finalize the rule.'],
        [/^Đã lập chỉ mục ([\d.,]+[KMB]?) lượt; gắn ([\d.,]+[KMB]?) lượt subagent vào nhiệm vụ cha\. “Review cứng” là case yếu hoặc chưa rõ; “audit đáng nghi” là case máy đang khá tự tin nhưng có tổ hợp tín hiệu nên kiểm tra\. Chọn một nhóm audit để duyệt các mẫu tương đồng và chốt rule\. Chỉ hiện 300\/([\d.,]+) kết quả phù hợp\.$/, 'Indexed $1 turns; attached $2 subagent turns to their parent missions. “Required review” covers weak or unclear cases; “suspicious audit” covers cases where the classifier is fairly confident but the signal combination merits review. Select an audit group to review similar samples and finalize the rule. Showing 300/$3 matching results.'],
        [/^Không thể lưu hiệu chỉnh: (.+)$/, 'Could not save review: $1'],
    ];
    ...
    function updateDocumentMetadata() {
        ...
        document.title = language === 'en'
            ? 'Usage Tracker — Codex and Gemini Analytics'
            : 'Usage Tracker — Theo dõi Codex và Gemini';
        ...
        if (description) {
            description.content = language === 'en'
                ...
                : 'Dashboard cục bộ phân tích usage, token, hạn mức, chi phí và nhiệm vụ của Codex và Gemini/Antigravity';
        }
