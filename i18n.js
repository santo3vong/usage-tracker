(() => {
    ...
    const EN = [
        ...
        ['Thời Gian Trung Bình Hoàn Thành Nhiệm Vụ', 'Average Task Completion Time'],
        ['Đường trung bình trượt của thời gian xử lý thực đo từ các lượt Codex đã hoàn tất. Các khoảng chờ giữa những lần bạn quay lại sửa không được cộng vào thời gian xử lý.', 'Rolling mean of observed work time from completed Codex turns. Time waiting between later corrections is excluded.'],
        ...
        ['Xu hướng thời gian xử lý trung bình của nhiệm vụ Codex đã hoàn tất', 'Average active duration of accepted Codex tasks over time'],
